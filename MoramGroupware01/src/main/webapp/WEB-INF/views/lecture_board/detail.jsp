		...
		<div class="sidebar-collapse">
			<ul class="nav" id="main-menu">
				...
				<li><a href="#"><i class="fa fa-table "></i>전자우편<span
						class="fa arrow"></span></a>
					<ul class="nav nav-second-level">
						<li class="childTab"><a href="#">받은 메일함</a></li>

						<li class="childTab"><a href="#">편지쓰기</a></li>
						<li class="childTab"><a href="#">보낸 메일함</a></li>
						<li class="childTab"><a href="#">휴지통</a></li>
				...
				<li><a href="#"><i class="fa fa-sitemap "></i>Project 게시판<span
					...
					<ul class="nav nav-second-level">
						...
						<li class="childTab" id = "authorization2"><a href="/../groupware/team_one_board/list">그냥2조</a></li>
						<li class="childTab" id = "authorization3"><a href="/../groupware/team_one_board/list">성준이네</a></li>
						<!--  <li>
				...
				<li><a href="#"><i class="fa fa-qrcode "></i>마이페이지<span
						class="fa arrow"></span></a>
					<ul class="nav nav-second-level">
						<li class="childTab"><a href="#">개인정보수정</a></li>
		...
		<div id="page-wrapper">
			<div id="page-inner">
				...
				<form action="update" id="frm">
					...
					<input style="font-style: gray;" type="hidden"
						value="${dateString }" readonly /> <br />

					<table>
						<tbody>
							<tr>
								<th>
									<!-- title --> <input style="height: 25px;" type="text"
									value="[수업] ${boardVO.title }" name="title" readonly />
								</th>
							</tr>
							<tr>
								<td>
									<!-- Writer --> <input type="text"
									value="글쓴이 : ${boardVO.userid}" name="userid" readonly />작성일 :
									${dateString }
								</td>
							</tr>
							...
							<tr>
								<td>
									<!-- content -->
									<div
										style="width: 800px; margin-bottom: 50px; margin-top: 50px;">${boardVO.content}</div>
								</td>
							</tr>

							<tr>
								<td style="height: 50px;">
									<button type="button" id="btnList">Go to List</button> <c:if
										test="${boardVO.userid eq id }">
										<button type="submit" id="updatebutton">Update</button>
									</c:if> <input type="hidden" name="page" value="${page }" />
								</td>
							</tr>
				...
				<div>
					<input type="text" name="rtext" id="rtext" placeholder="write it"
						required /> <input type="text" name="replier" id="replier"
