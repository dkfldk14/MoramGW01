...
<body>
	...
	<table>
		...
		<tr>
 			...
 			<td colspan="2" >	<input type="text"  style="width: 72px;" readonly="readonly" value="${ApprovalVO.usedatestart}">    &nbsp;~&nbsp;&nbsp;&nbsp;<input type="text" style="width: 122px; " readonly="readonly" value ="${ApprovalVO.usedateend}"></td>
		</tr>
		<tr>
 			<td>제출일자</td>
 			<td colspan="2">
 			<input type="text" value="${ApprovalVO.draftdate}"/>
 			</td>
