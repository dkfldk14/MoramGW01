...
<table class="tg">
  <tr>
    <th class="tg-yzt1" colspan="9" style="text-align: center; font-size: 25px; font-style: bold;">기 결 함</th>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="tg-yzt1">결재 완료</td>
  </tr>
  
	 <c:forEach var="dto" items="${FinishDTO }">
  <tr>
    <td class="tg-yzt1"></td>
    <td class="tg-b7b8"><a href="register-finish?draft_index=${dto.draft_index }">${dto.draft_index }</a></td>
