...
@Repository
public class TeamOneBoardDAOImpl implements TeamOneBoardDAO {

	private static final String NAMESPACE = "TeamoneMapper";
	private static final String NAMESPACEFORREPLY = "TeamoneReplyMapper";
