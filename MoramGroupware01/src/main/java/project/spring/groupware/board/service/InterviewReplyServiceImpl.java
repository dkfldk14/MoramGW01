...
import project.spring.groupware.board.persistence.InterviewReplyDAO;



@Service
public class InterviewReplyServiceImpl implements InterviewReplyService {

	@Autowired
	private InterviewReplyDAO dao;
