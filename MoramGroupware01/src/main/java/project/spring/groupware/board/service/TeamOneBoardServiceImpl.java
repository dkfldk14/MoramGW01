...
import project.spring.groupware.board.persistence.TeamOneBoardDAO;
import project.spring.groupware.board.searchutil.SearchCriteria;

@Service
public class TeamOneBoardServiceImpl implements TeamOneBoardService {

	@Autowired
	private TeamOneBoardDAO dao;
