...
@Repository
public class TeamThreeBoardDAOImpl implements TeamThreeBoardDAO {

	private static final String NAMESPACE = "TeamthreeMapper";
	private static final String NAMESPACEFORREPLY = "TeamthreeReplyMapper";
