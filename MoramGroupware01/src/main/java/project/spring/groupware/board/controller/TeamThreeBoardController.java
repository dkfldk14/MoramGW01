...
import project.spring.groupware.board.service.TeamThreeBoardService;
import project.spring.groupware.board.service.TeamThreeReplyService;


@Controller
@RequestMapping(value="team_three_board")
public class TeamThreeBoardController {
	private static final Logger logger =
			LoggerFactory.getLogger(NewsBoardController.class);
	
	@Autowired
	private TeamThreeBoardService boardService;
	
	@Autowired
	private TeamThreeReplyService replyService;
