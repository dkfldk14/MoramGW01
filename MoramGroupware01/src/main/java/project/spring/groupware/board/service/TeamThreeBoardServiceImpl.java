...
import project.spring.groupware.board.persistence.TeamThreeBoardDAO;
import project.spring.groupware.board.searchutil.SearchCriteria;

@Service
public class TeamThreeBoardServiceImpl implements TeamThreeBoardService {

	@Autowired
	private TeamThreeBoardDAO dao;
